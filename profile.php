...
$sql="update tblusers set FullName=:name,ContactNo=:mobileno,dob=:dob,gender=:gender,Address=:adress where EmailId=:email";
         ...
         if($msg){?><div class="succWrap"><strong>SUCCESS</strong>:<?php echo htmlentities($msg); ?> </div><?php }?>
                        <form method="post">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control white_bg" name="gender" value="<?php echo htmlentities($result->gender);?>" id="gender" type="text" required>
                            </div>
                            <div class="form-group">
