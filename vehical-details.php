                    ...
                    <div class="sidebar_widget">
                        ...
                        <form method="post">
                            <div class="form-group">
                                ...
                                <input type="date" class="form-control"  min=<?php echo $min; ?> max=<?php echo $max; ?> name="fromdate" placeholder="From Date" required>
                            </div>
                            <div class="form-group">
                                <label>To Date:</label>
                                <input type="date" class="form-control"  min=<?php echo $min; ?> max=<?php echo $max; ?>  name="todate" placeholder="To Date" required>
                            </div>
